...
export const packages = [
  ...
  {
    slug: "amarnath-yatra-package-4d",
    name: "Amarnath Yatra Package",
    duration: "3N/4D",
    destinations: "Srinagar, Sonmarg, Baltal, Panjtarni",
    price: "Rs 12,399",
    originalPrice: "Rs 15,999",
    badge: "Spiritual",
    type: "Pilgrimage",
    ...
    itinerary: [
      ...
      { day: 2, title: "Sonmarg - Srinagar via Baltal", details: "Early morning transfer to 18km Baltal and take a Helicopter for Panjtarni. After darshan, return to Baltal by helicopter and proceed to Srinagar. Evening Shikara ride on Dal Lake to enjoy the sunset. Overnight at Houseboat/Hotel." },
      { day: 3, title: "Srinagar Sightseeing", details: "Morning after breakfast, tour of the famous Mughal Gardens. Visit Nishat Garden, Shalimar Garden, Chashma Shahi, and Pari Mehal. Overnight stay in Srinagar." },
      { day: 4, title: "Departure", details: "After breakfast, drop at Srinagar Airport for your onward journey back home." }
    ]
  },
  {
    slug: "amarnath-yatra-3d",
    name: "Amarnath Yatra Short Package",
    duration: "2N/3D",
    destinations: "Srinagar, Sonmarg, Baltal, Panjtarni",
    price: "Rs 10,299",
    ...
    itinerary: [
      { day: 1, title: "Srinagar - Sonmarg", details: "Arrival at Srinagar Airport, pick up and transfer to Sonmarg. Check in at hotel/tent. Evening free for Leisure. Overnight at Sonmarg Hotel/Swiss Tented Accommodation." },
      { day: 2, title: "Sonmarg - Srinagar via Baltal", details: "Early morning transfer to 18km Baltal and take a Helicopter for Panjtarni. After darshan, return to Baltal by helicopter and proceed to Srinagar. Evening Shikara ride on Dal Lake to enjoy the sunset. Overnight at Houseboat/Hotel." },
      { day: 3, title: "Departure", details: "After breakfast, drop at Srinagar Airport for your onward journey back home." }
    ]
  },
  {
...
export const rentalVehicles: RentalVehicle[] = [
  ...
  {
    id: "urbania",
    name: "Force Urbania (12 & 17 Seater)",
    category: "Luxury Van",
    seats: 17,
    bags: 8,
    transmission: "Manual",
  ...
  },
  {
    ...
    ac: true,
    pricePerDay: 5199,
    image: "/images/tempo-10-seater.png",
    rating: "4.2",
    reviews: "9,800",
    duration: "5 hour 00 mins",
    luggageDetails: "Inside",
    parking: "Paid",
    tollTaxes: "Paid",
    assistance: "24X7"
  ...
  },
  {
    ...
    ac: true,
    pricePerDay: 6500,
    image: "/images/bus-35-seater.png",
    rating: "4.4",
    reviews: "10,500",
