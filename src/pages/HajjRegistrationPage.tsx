...
export function HajjRegistrationPage() {
  return (
    <main className="w-full bg-background text-on-background font-sans antialiased overflow-x-hidden">
      <section className="relative min-h-[819px] flex items-center justify-center p-6 @container">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left flex flex-col gap-6">
            ...
            <h1 className="text-on-primary font-display text-[36px] lg:text-[56px] font-bold leading-[1.2] lg:leading-[1.1] tracking-[-0.02em]">
          ...
          <div className="w-full max-w-md bg-surface/95 backdrop-blur-md rounded-xl shadow-xl p-8 border border-outline-variant/30">
            <h3 className="text-center font-serif text-[24px] text-primary mb-6">Time Until Expected Hajj Season</h3>
            <div className="flex gap-4 justify-center">
              <div className="flex flex-col items-center gap-2">
                <div className="flex h-16 w-16 sm:h-20 sm:w-20 items-center justify-center rounded-lg bg-surface-container-highest shadow-inner">
      ...
      <section id="details" className="py-24 px-6 bg-surface">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="font-display text-[32px] font-semibold text-primary mb-4">Expected Package Preview</h2>
      ...
      <section id="register" className="py-24 px-6 bg-surface-container-low">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="flex flex-col justify-center">
            <h2 className="font-display text-[32px] font-semibold text-primary mb-8">Why Pre-Register Early?</h2>
          ...
          <div className="bg-surface rounded-2xl shadow-lg p-8 border border-outline-variant/50">
